...
public class Rogue extends Character{
    public Rogue(String name) {
        super(name);
        this.roleClass = RoleClass.ROGUE;
        this.baseStats.setRogueStats();
    ...
    public void equipWeapon(Weapon weapon) throws InvalidWeaponException {
        ...
        } else if (weapon.getWeaponType() == WeaponType.DAGGER || weapon.getWeaponType() == WeaponType.SWORD) {
    ...
    /**
     * Calculate the damage per second of the character. Rogue have a increase in damage by 1% for each dexterity point.
    ...
    public void levelUp() {
        this.level += 1;
        this.baseStats.updateDexterity(4);
